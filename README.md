...
I work as an AI Automation Strategist, designing smart workflows that connect AI, data, and business processes into one scalable system.

What I do:
• Build AI-powered workflows to eliminate repetitive tasks
• Design AI chatbots for sales, support, and internal operations
• Automate leads, follow-ups, and customer communication

My approach is simple:
understand the business first, then apply AI where it creates real impact.

No unnecessary complexity.
Just practical, scalable automation.

Core stack: n8n, Make, Zapiar, AI Agents, Chatbots, Voice AI, LLM integrations.

DM me if you want AI automation that actually works.
